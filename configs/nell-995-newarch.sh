...
checkpoint_path="model/NELL-995.test-point.rs.new.conve-xavier-curriculum-200-200-3-0.003-0.1-0.1-0.1-256-0.05-3-10.0-0.85-0.1-useConf-3-0.9-test/model_best.tar"
